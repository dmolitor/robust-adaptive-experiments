...
bandit algorithm used here is Thompson Sampling and the experiment will stop
...
above to first improve the width of our CS by 50% and then stop the experiment.
```{python}
exp_simple = MAD(
    bandit=TSBernoulli(k=2, control=0, reward=reward_fn),
    alpha=0.05,
